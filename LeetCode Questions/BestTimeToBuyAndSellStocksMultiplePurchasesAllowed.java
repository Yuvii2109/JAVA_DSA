/*
    ...
    a given stock on the ith day. On each day, you may decide to buy and/
    or sell the stock. You can only hold at most one share of the stock at 
    any time. However, you can buy it then immediately sell it on the same 
...
public class BestTimeToBuyAndSellStocksMultiplePurchasesAllowed {
    public int maxProfit(int[] prices) {
        ...
        while(i < n-1){
            ...
            result += localMaxima - localMinima;
        }
        return result;
    }
}